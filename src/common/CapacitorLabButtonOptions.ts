...
export const LIGHT_SURFACE_TEXT_FILL = CapacitorLabColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link CapacitorLabColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const CAPACITOR_LAB_COMBO_BOX_OPTIONS = {
  buttonFill: CapacitorLabColors.controlSurfaceColorProperty,
  listFill: CapacitorLabColors.controlSurfaceColorProperty,
  buttonStroke: CapacitorLabColors.panelBorderColorProperty,
  listStroke: CapacitorLabColors.panelBorderColorProperty,
...
export const FLAT_PANEL_PUSH_BUTTON_OPTIONS = {
  ...
  baseColor: CapacitorLabColors.controlSurfaceColorProperty,
} as const;
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: CapacitorLabColors.textColorProperty },
  },
