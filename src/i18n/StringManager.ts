 ...
 */
export type CapacitorLabA11yStrings = {
 ...
 * Same sync rule as {@link CapacitorLabA11yStrings}.
 */
...
export class StringManager {
  ...
  public getScreenNames(): {
    ...
    readonly dielectricStringProperty: ReadOnlyProperty<string>;
    readonly multipleCapacitorsStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      introductionStringProperty: stringProperties.screens.introductionStringProperty,
      dielectricStringProperty: stringProperties.screens.dielectricStringProperty,
      multipleCapacitorsStringProperty: stringProperties.screens.multipleCapacitorsStringProperty,
    };
  }

  /** Accessibility strings for the Introduction screen. */
  public getIntroductionA11yStrings() {
    return stringProperties.a11y.introduction;
  }

  /** Accessibility strings for the Dielectric screen. */
  public getDielectricA11yStrings() {
    return stringProperties.a11y.dielectric;
  }

  /** Accessibility strings for the Multiple Capacitors screen. */
  public getMultipleCapacitorsA11yStrings() {
