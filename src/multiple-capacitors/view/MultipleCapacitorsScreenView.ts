...
import { MultipleCapacitorsScreenSummaryContent } from "./MultipleCapacitorsScreenSummaryContent.js";

export type MultipleCapacitorsScreenViewOptions = ScreenViewOptions;

export class MultipleCapacitorsScreenView extends ScreenView {
  public constructor(model: MultipleCapacitorsModel, providedOptions?: MultipleCapacitorsScreenViewOptions) {
    ...
    // it the same way. See MultipleCapacitorsScreenSummaryContent for the four content regions.
    const options = optionize<MultipleCapacitorsScreenViewOptions, EmptySelfOptions, ScreenViewOptions>()(
      {
        screenSummaryContent: new MultipleCapacitorsScreenSummaryContent(model),
      },
      providedOptions,
    );
    super(options);
    ...
    const placeholderText = new Text(StringManager.getInstance().getScreenNames().multipleCapacitorsStringProperty, {
  ...
  //
  // private readonly disposeMultipleCapacitorsScreenView: () => void;
  //
  ...
  //   [model.stateProperty],
  //   (state) => `State: ${state}`,
  // ); // → pass as currentDetailsContent in MultipleCapacitorsScreenSummaryContent
  // const onExternal = (v: number) => { /* … */ };
  // model.externalProperty.link(onExternal); // Property you do NOT own
  //
  // this.disposeMultipleCapacitorsScreenView = () => {
